# Webtoon Scraping and Sentiment Analysis
 웹툰을 랭킹순으로 정렬한뒤 댓글을 크롤링하여 웹툰이 랭킹이 높을 경우 혹은 낮을 경우 긍정적 댓글, 부정적 댓글의 수 차이를 분석하고 워드클라우드를 만드는 프로젝트입니다. 감정분석은 google cloud를 사용 하였습니다.
## py files
